...
export default function BespokeSection() {
  return (
    <section className="bg-[#131813] text-white py-16">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 px-8 md:px-16">
          ...
          <p className="text-lg italic text-gray-400 mt-2">High Quality</p>
          ...
          {/* Explore Button */}
          <button className="mt-6 px-6 py-2 border border-gray-400 text-white text-sm uppercase tracking-wider hover:bg-white hover:text-black transition">
            Explore
          </button>
        </div>
